...
class LenvsHTMLExporter(HTMLExporter):
    ...
    export_from_notebook = "HTML with latex_env"
...
class LenvsSlidesExporter(SlidesExporter):
    ...
    export_from_notebook = "Reveal.js slides with latex_env"
...
class LenvsTocHTMLExporter(LenvsHTMLExporter):
    ...
    export_from_notebook = "HTML with toc and latex_env"
...
class LenvsLatexExporter(LatexExporter):
    ...
    export_from_notebook = "LaTeX with latex_env"
