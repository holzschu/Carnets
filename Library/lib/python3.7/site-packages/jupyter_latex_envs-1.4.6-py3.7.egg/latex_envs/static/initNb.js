...
function loadLatexUserDefs() {
    $.get('latexdefs.tex').done(function(data) {
        ...
        window.webkit.messageHandlers.Carnets.postMessage('latex_envs: loaded user LaTeX definitions latexdefs.tex');
        console.log('latex_envs: loaded user LaTeX definitions latexdefs.tex');
        onMarkdownCellRendering();
    }).fail(function() {
        window.webkit.messageHandlers.Carnets.postMessage('latex_envs: failed to load user LaTeX definitions latexdefs.tex');
...
function loadUserEnvsCfg(callback) {
        ...
        //var jqxhr = $.getJSON( "example.json", function(data) { //in current directory
          ...
          .fail(function(data) {
			...
			window.webkit.messageHandlers.Carnets.postMessage("latex_envs: error loading /nbextensions/latex_envs/user_envs.json");
...
function loadEnvsLaTeX(callback) {
    ...
    var jqxhr = $.getJSON(baseUrl + "nbextensions/latex_envs/envsLatex.json")
        ...
        .fail(function(jqxhr, textStatus, error) {
			...
			window.webkit.messageHandlers.Carnets.postMessage("latex_envs: error loading /nbextensions/latex_envs/envsLatex.json");
			window.webkit.messageHandlers.Carnets.postMessage("Request Failed: " + err);
