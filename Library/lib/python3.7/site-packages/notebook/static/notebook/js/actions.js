...
define([
    ...
    var _actions = {
        ...
        // iOS: allow access to entire folder
        'allow-folder-access': {
            help_index : 'aa',
            cmd: i18n.msg._('allow acces to folder'),
            help: i18n.msg._('grant permission access to folder'),
            icon: 'fa-folder-open-o',
            handler : function(env){
                env.notebook.allow_folder_access();
            }
        },
        // iOS: open webpage without leaving the app.
        'open-webpage': {
            help_index : 'aa',
            cmd: i18n.msg._('open external webpage'),
            help: i18n.msg._('open a webpage without leaving the app'),
            icon: 'fa-safari',
            handler : function(env){
                env.notebook.open_webpage();
            }
        },
