...
int __srget(FILE *);
int __svfscanf(FILE *, const char *, ...); 
...
int vfscanf(FILE * restrict __stream, const char * restrict __format, ...);  
int vscanf(const char * restrict __format, ...);  
int vsnprintf(char * restrict __str, size_t __size, const char * restrict __format, ...);  
int vsscanf(const char * restrict __str, const char * restrict __format, ...);  
